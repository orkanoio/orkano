...
> **Status: pre-alpha (Phase 0 — Foundations).** Nothing here is deployable yet. The current work is architecture decisions, the security baseline, and the CRD API. See [TASKS.md](TASKS.md).
...
| `/docs` | ADRs (`docs/adr`), security docs (`docs/security`), examples (`docs/examples`). |
