...
- **Free churn while alpha** is technically licensed by Kubernetes convention, but it spends early adopters' trust, the launch asset Orkano needs most.
- **Promise stability (jump to v1beta1 now)** is dishonest before the operator has reconciled a single real workload.
