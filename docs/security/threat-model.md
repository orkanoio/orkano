...
**In scope:** the components Orkano ships — dashboard (React UI + Go API), webhook receiver, operator, build jobs, the in-cluster registry, the Postgres metadata DB, catalog databases, and the optional Mongo Express development UI.
