...
type Invocation struct {
	...
	// Dockerfile is generated by the static-strategy task rather than read
	// from the repo.
...
func Compose(build *orkanov1alpha1.Build) Invocation {
	...
	case orkanov1alpha1.StrategyStatic:
		// The Dockerfile is generated by the static-strategy task, not read
		// from the repo, so no DockerfilePath is composed here.
	}
	return inv
}
